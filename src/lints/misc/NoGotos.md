The use of `goto` is discouraged because it generally makes scripts less readable and harder to maintain.
Consider using [`else`], [`blocks`], [`break`], and [`continue`] as substitutes for `goto`.
